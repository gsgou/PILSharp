...
namespace PILSharp.Sample
{
    ...
    public static class ResourceLoader
    {
        ...
        public static Stream GetEmbeddedResourceStream(Assembly assembly, string resourceFileName)
        {
            ...
            {
                throw new Exception(string.Format("Multiple resources ending with {0} found: {1}{2}",
                                    resourceFileName, Environment.NewLine, string.Join(Environment.NewLine, resourcePaths)));
            }
